...
public class Enemy3 : MonoBehaviour
{
    ...
    public void Turn_Enemy()
    {
        ...
        if (wavepointIndex == 1 || wavepointIndex == 7 || wavepointIndex == 11 || wavepointIndex == 13 || wavepointIndex == 19 || wavepointIndex == 23 || wavepointIndex == 27)
        {
            if (turn_check == true)
            {
        ...
        if (wavepointIndex == 3 || wavepointIndex == 5 || wavepointIndex == 9 || wavepointIndex == 15 || wavepointIndex == 17 || wavepointIndex == 21 || wavepointIndex == 25)
        {
            if (turn_check == true)
            {
                gameObject.transform.Rotate(0.0f, 90.0f, 0.0f);
